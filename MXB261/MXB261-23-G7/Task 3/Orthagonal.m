...
% Generating Orthagonal Latin Hypercube Samples
lhs = orthogonal_lhs_3d(num_samples, param_ranges);
...
title('Orthogonal LHS Succesful Paramater Samples', 'FontSize', 16);
